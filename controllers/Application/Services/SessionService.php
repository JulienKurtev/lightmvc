        ...
        if ($this->postLoginForm === TRUE) {
            ...
            switch ($this->errorMessage) {
                case 0:
                    ...
                    break;
                case 1:
                    $this->userMessage = 'Wrong credentials!  <a href="/login">Try again</a>.';

                    break;
                case 2:
                    $this->userMessage = 'You are logged out!  <a href="/login">You can login again</a>.';
                    break;
                case 3:
                    $this->userMessage = 'Invalid session <a href="/login">Please login again</a>.';
                    break;
            }
        }
    }
